...
class ckcoreShadows {
  ...
  static ckcoreShadows light() => const ckcoreShadows(
    none: [],
    sm: [
  ...
  static ckcoreShadows dark() => const ckcoreShadows(
    none: [],
    // Dark mode small shadow increased for better visibility on dark
    // surfaces while staying subtle.
    sm: [
