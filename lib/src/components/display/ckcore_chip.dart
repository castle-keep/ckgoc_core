...
class CKFilterChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isDraft = state == ChipState.draft;
...
class CKInputChip extends StatelessWidget {
  const CKInputChip({
    required this.label,
    this.onRemove,
    this.state = ChipState.defaultState,
  ...
  Widget build(BuildContext context) {
    ...
    final Color fg = isError
        ? colors.error
        : (isDraft ? colors.onSurfaceVariant : colors.onSurface);
    final Color borderColor = isError
        ? colors.error
        : (isDraft ? colors.outlineVariant : colors.outline);
...
/// Deprecated: Use [CKFilterChip] instead.
@Deprecated('Use CKFilterChip instead')
/// Deprecated: Use [CKFilterChip] instead.
@Deprecated('Use CKFilterChip instead')
typedef ckcorefilterChip = CKFilterChip;
