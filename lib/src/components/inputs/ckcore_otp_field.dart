...
class CKOtpField extends StatefulWidget {
  const CKOtpField({
    this.length = 6,
    this.onChanged,
    this.onCompleted,
  ...
  @override
  State<CKOtpField> createState() => _CompanyOtpFieldState();
}

class _CompanyOtpFieldState extends State<CKOtpField> {
...
/// Deprecated: Use [CKOtpField] instead.
@Deprecated('Use CKOtpField instead')
typedef ckcoreotpField = CKOtpField;
